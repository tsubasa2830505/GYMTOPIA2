            ...
            <div key={review.id} className="bg-white rounded-lg shadow-sm p-6">
              <div className="flex items-start justify-between mb-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-[color:var(--foreground)]">{review.user_display_name}</h3>
                    <p className="text-sm text-[color:var(--text-subtle)]">{review.gym_name}</p>
                  </div>
                </div>
              ...
              {review.title && (
                <h4 className="font-medium text-[color:var(--foreground)] mb-2">{review.title}</h4>
              )}

              <p className="text-[color:var(--text-subtle)] mb-4 leading-relaxed">{review.content || ''}</p>
                ...
                <div className="border-t pt-4">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                    {review.equipment_rating && (
                      <div>
                        <span className="text-[color:var(--text-subtle)]">設備: </span>
                        <span className="font-medium">{review.equipment_rating}/5</span>
                      </div>
                    )}
                    {review.cleanliness_rating && (
                      <div>
                        <span className="text-[color:var(--text-subtle)]">清潔さ: </span>
                        <span className="font-medium">{review.cleanliness_rating}/5</span>
                      </div>
                    )}
                    {review.staff_rating && (
                      <div>
                        <span className="text-[color:var(--text-subtle)]">スタッフ: </span>
                        <span className="font-medium">{review.staff_rating}/5</span>
                      </div>
                    )}
                    {review.accessibility_rating && (
                      <div>
                        <span className="text-[color:var(--text-subtle)]">アクセス: </span>
