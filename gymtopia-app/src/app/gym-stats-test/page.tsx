...
export default function GymStatsTestPage() {
  ...
  if (error) {
    return (
      <div className="min-h-screen bg-[rgba(243,247,255,0.96)] flex items-center justify-center">
        <div className="text-center">
          <p className="text-[#e0707a]">エラー: {typeof error === 'string' ? error : JSON.stringify(error)}</p>
        </div>
      </div>
    )
  }
    ...
    <div className="min-h-screen bg-[rgba(243,247,255,0.96)] p-8">
      ...
      <div className="gt-card p-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="bg-[rgba(76,122,255,0.12)] p-4 rounded">
        ...
        <div className="mt-6">
          ...
          <pre className="bg-[rgba(243,247,255,0.92)] p-4 rounded text-sm overflow-auto">
