...
function ProfileContent() {
  ...
  }, [userId, searchParams]); // Depend on userId and searchParams
  ...
  useEffect(() => {
    ...
    if (refreshParam) {
      console.log('🔄 Refresh parameter detected:', refreshParam);
  ...
  }, [searchParams]); // Monitor searchParams for refresh parameter
