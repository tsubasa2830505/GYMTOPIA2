...
export default function Header({ title, subtitle }: HeaderProps = {}) {
  ...
  return (
    <>
      <header className="fixed top-0 left-0 right-0 z-40 border-b border-[rgba(44,82,190,0.18)] bg-[rgba(247,250,255,0.9)] backdrop-blur-xl shadow-[0_20px_46px_-28px_rgba(15,36,118,0.44)]">
        <div className="max-w-7xl mx-auto px-4 h-16 sm:h-[73.5px] flex items-center justify-between">
          <div className="flex items-center gap-2 sm:gap-3">
            <div className="w-9 h-9 sm:w-[42px] sm:h-[42px] bg-gradient-to-br from-[#1f4fff] to-[#2a5fe8] rounded-full flex items-center justify-center shadow-[0_16px_34px_-20px_rgba(15,36,118,0.46)]">
            ...
            <div className="absolute top-full right-4 mt-2 w-64 gt-card z-50 overflow-hidden">
              <div className="p-2 space-y-1">
                <button
                  ...
                  className="w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-all hover:bg-[rgba(243,247,255,0.92)]"
                >
                ...
                <div className="border-t border-[rgba(44,82,190,0.18)]" />
