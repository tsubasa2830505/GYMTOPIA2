-- =========================================
-- Mock Data for Test User (muscle_taro)
-- =========================================
...
-- Insert post likes (some engagement)
...
-- Insert user posts (for profile page)
...
-- Insert some follower relationships for social features
-- Note: These would be other users following muscle_taro, but we'll create placeholder users
